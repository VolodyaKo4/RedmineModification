...
<<<<<<< HEAD
        format.pdf  { send_data(issues_to_pdf_dispatch(@issues, @project, @query), :type => 'application/pdf', :filename => 'issues.pdf') }
=======
...
<<<<<<< HEAD
	...
	send_data(pdf, :type => 'application/pdf', :filename => "#{@project.identifier}-#{issue_id}.pdf")
=======
